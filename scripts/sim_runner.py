...
FEATURES_CONFIG_PATH = BASE_DIR / "pipelines" / "system1_trading.features.yaml"
...
def run(sim_filter=None, full=False):
    config = load_config(CONFIG_PATH, FEATURES_CONFIG_PATH)
...
if __name__ == "__main__":
    ...
    run(sim_filter=args.sim, full=args.full)
