...
FAILED_UNIT_HINTS: dict[str, dict[str, Any]] = {
    ...
    "openclaw-source-ui-local.service": {
        "label": "Source UI Local",
        "kind": "source-ui",
        "optional": False,
        "summary": "Local Source UI bind on 127.0.0.1:18990 needs attention.",
    },
    "openclaw-tool-ain-phi.service": {
        "label": "Source UI Local (legacy alias)",
        "kind": "legacy alias",
        "optional": True,
        "summary": "Legacy alias for the local Source UI service. Migrate to openclaw-source-ui-local.service.",
    },
