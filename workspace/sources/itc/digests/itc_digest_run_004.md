...
1. Temporal ranking within COMMUNITY tier: Items in COMMUNITY section are ordered by recency (most recent first)
2. Basic deduplication within tiers: Removes redundant content, preserving most recent version of duplicated content

Interaction Rule: Temporal ranking applies first, then deduplication removes redundant items, preserving the most recent version of any duplicated content within each tier.
...
## COMMUNITY Content (Curated Forum) - Temporal Ranking + Deduplication Applied
