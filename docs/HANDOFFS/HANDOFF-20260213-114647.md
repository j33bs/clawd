...
- The OpenAI API model IDs are intentionally aligned to official API docs (`gpt-5-chat-latest`, `gpt-5-mini`, `gpt-5-codex`), not the internal auth-route IDs seen in session logs.
