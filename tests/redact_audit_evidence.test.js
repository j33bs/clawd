...
test('CLI redacts synthetic fixtures and writes output bundle', function () {
  ...
  assert.ok(!credentialsOut.includes('sk-TEST123456789'), 'OpenAI-like key should be redacted');
  assert.ok(!credentialsOut.includes('ghp_FAKE12345678901234567890'), 'GitHub-like key should be redacted');
  ...
  assert.ok(!metadataOut.includes('sk-TESTABCDE12345'), 'JSON token should be redacted');
