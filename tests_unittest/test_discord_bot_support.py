...
class TestDiscordBotSupport(unittest.TestCase):
    ...
    def test_build_telegram_chat_prompt_includes_shared_context_packets(self):
        with mock.patch("api.discord_bot_support.build_relational_prompt_lines") as relational_mock:
        ...
        relational_mock.assert_not_called()
        ...
        self.assertIn("Relevant remembered context:", prompt)
        self.assertNotIn("Current relational state:", prompt)
